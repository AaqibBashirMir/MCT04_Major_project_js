...
let dataArray = [
  ...
  {
    image:
      "https://rukminim2.flixcart.com/image/612/612/xif0q/usb-gadget/q/b/r/adapter-expansion-for-pc-notebook-laptop-computer-mac-linux-original-imaghgwvxh8ynsze.jpeg?q=70",
  ...
  {
    image:
      "https://rukminim2.flixcart.com/image/612/612/l2dmky80/usb-gadget/h/a/l/por-1572-portronics-original-imagdq8hbzkfu8yj.jpeg?q=70",
  ...
  {
    image:
      "https://rukminim2.flixcart.com/image/612/612/ksgehzk0/usb-gadget/q/c/q/usb-hub-zeb-90hb-zebronics-original-imag6ymzfeyuevmt.jpeg?q=70",
  ...
  {
    image:
      "https://rukminim2.flixcart.com/image/612/612/kw5ag7k0/laptop-accessories-combo/d/s/j/mport-31-1-portronics-original-imag8vufkje2revf.jpeg?q=70",
    ...
    image:
      "https://rukminim2.flixcart.com/image/612/612/koad9jk0/usb-gadget/x/h/w/100hb-zebronics-original-imaf8r2gbb3rzqfh.jpeg?q=70",
  ...
  {
    image:
      "https://rukminim2.flixcart.com/image/612/612/xif0q/usb-gadget/f/m/u/-original-imagppnd3hkuv6k4.jpeg?q=70",
  ...
  {
    image:
      "https://rukminim2.flixcart.com/image/612/612/xif0q/usb-gadget/k/h/9/sd-tf-cards-reader-2-usb-3-0-ports-bestor-original-imaghgw3ahqbjabe.jpeg?q=70",
  ...
  {
    image:
      "https://rukminim2.flixcart.com/image/612/612/l4rd0280/usb-gadget/0/x/p/with-2-0-x-4-ports-portronics-original-imagfh3y8g8dsefx.jpeg?q=70",
  ...
  {
    image:
      "https://rukminim2.flixcart.com/image/612/612/l4rd0280/usb-gadget/k/h/f/with-2-0-x-4-ports-portronics-original-imagfh3yzsuyusdz.jpeg?q=70",
  ...
  {
    image:
      "https://rukminim2.flixcart.com/image/612/612/l2rwzgw0/usb-gadget/c/c/g/type-c-to-4-usb-a-ports-bestor-original-imagefmhyffgjpvf.jpeg?q=70",
  ...
  {
    image:
      "https://rukminim2.flixcart.com/image/612/612/xif0q/usb-gadget/s/s/l/hc000016-lap-ph-4u-honeywell-original-imagtvjrxrmmyswh.jpeg?q=70",
  ...
  {
    image:
      "https://rukminim2.flixcart.com/image/612/612/kwqq1zk0/usb-gadget/p/h/p/por-1485-portronics-original-imag9cz4kqpznpvt.jpeg?q=70",
  ...
  {
    image:
      "https://rukminim2.flixcart.com/image/612/612/khtghow0-0/usb-gadget/e/l/t/zeb-ta500u-4-in-1-zebronics-original-imafxqygfz3gjfuf.jpeg?q=70",
  ...
  {
    image:
      "https://rukminim2.flixcart.com/image/612/612/kfeamq80/usb-gadget/g/r/m/3-0-with-charging-function-amkette-original-imafvv3kfdghsaca.jpeg?q=70",
  ...
  {
    image:
      "https://rukminim2.flixcart.com/image/612/612/jtd98y80/usb-gadget/g/3/f/uh700-tp-link-original-imafeqh2anw6gph4.jpeg?q=70",
  ...
  {
    image:
      "https://rukminim2.flixcart.com/image/612/612/xif0q/usb-gadget/a/q/r/ocs-0250a-oneclickshopping-original-imags4ewuhrmfdxw.jpeg?q=70",
  ...
  {
    image:
      "https://rukminim2.flixcart.com/image/612/612/xif0q/usb-gadget/i/i/s/hc000011-lap-nph-4u-blk-honeywell-original-imaggg4hkzmdst2u.jpeg?q=70",
  ...
  {
    image:
      "https://rukminim2.flixcart.com/image/612/612/khavrm80/usb-gadget/h/r/c/por-1159-portronics-original-imafxcekdjcdtah4.jpeg?q=70",
  ...
  {
    image:
      "https://rukminim2.flixcart.com/image/612/612/xif0q/usb-gadget/f/d/4/-original-imaggbngtqzeaz9z.jpeg?q=70",
  ...
  {
    image:
      "https://m.media-amazon.com/images/I/71lVwl3q-kL._AC._SR360,460.jpg",

    title: "RoarX 25 W Quick Charge 3.1 A Mobile Charger with Detac...",
...
//special price
let specialPrice_checkbox = document.getElementById("special_offer");
specialPrice_checkbox.addEventListener("click",(e)=>{
    if(specialPrice_checkbox.checked){
        let data= [...dataArray];
        let sp_data = data.filter((ele)=> {
            return ele.discountPrice>25;
        })
        productContainer(sp_data);
    }else{
        productContainer(dataArray);
    }
})
...
let inputrange = document.getElementById("rangeOfPrize");
inputrange.addEventListener("input", (e) => {
//   console.log(e.target.value);
// inputrange=e.target.value;
  const roundedValue = roundToNearestHundred(e.target.value);
  console.log(roundedValue);
 if(roundedValue>250){
  let data = [...dataArray];
  let product_cost = data.filter((ele) => {
    return ele.price>=roundedValue;
  });
  productContainer(product_cost);
} else {
  productContainer(dataArray);
}
});
...
function roundToNearestHundred(value) {
    // console.log(value);
  return Math.round(value / 10) * 100>250?Math.round(value / 100) * 100:0;
}
document.getElementById("minimum").addEventListener("input",(e)=>{
...
//max
document.getElementById("maximum").addEventListener("input",(e)=>{
    const roundedValue = (e.target.value);
 if(roundedValue<1100){
  let data = [...dataArray];
  let product_cost = data.filter((ele) => {
    return ele.price>=roundedValue;
  });
